...
#
# The RPiMIB (Raspberry Pi Multi Interface Board) has two PWM outputs, which will be sufficient for this example. If we
...
#
# The above functionality of the RPiMIB is made possible primarily by the use of a Cypress Programmable System On a Chip
